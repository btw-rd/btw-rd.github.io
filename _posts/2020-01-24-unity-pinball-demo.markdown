...
date: 2020-01-24
tags: [unity, video games, pinball, black rose, code]
---
<style>img[src*="#preview"]{width:100%}</style>

![preview-image]({{site.url}}/code/unity-pinball-demo/preview.png#preview)  
...
The completed project can be viewed on my github profile [here](https://github.com/btw-rd/Unity-Exploration-5)  
